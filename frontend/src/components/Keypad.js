...
import { CALL_DISCONNECTED, CALL_LOG_RESET, CALL_RESET, CONTACT_SAVE_RESET } from '../consts/CallConsts';
    ...
    <div>
      <div className='keyPad'>
        {keypadMode==='keypad' && !loadingCall && !connected && <div>
          ...
          <div className='keyRow'>
            <button type="submit" value="1" onClick={() => input("1")} className='keyNum'><div className='keyContent'>1</div><div>⠀</div></button>
          ...
          <div className='keyRow'>
            ...
            <button type="submit" value="" className='keyNum' onClick={openOptionDialogBox}><div className='keyContent'><i className='fas fa-ellipsis-v'></i></div></button>
